...
train1 = pickle.load(open(root + 'embeddings_' + train_names[0] + '.pkl', 'rb'))
train2 = pickle.load(open(root + 'embeddings_' + train_names[1] + '.pkl', 'rb'))
val = pickle.load(open(root + 'embeddings_' + val_name + '.pkl', 'rb'))
val_labels = pickle.load(open(root + 'labels_' + val_name + '.pkl', 'rb'))
test = pickle.load(open(root + 'embeddings_' + test_name + '.pkl', 'rb'))
